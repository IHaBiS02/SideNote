...
for (const name of ['index.html', 'style.css', 'script.js', 'editor-session.js', 'vendor', 'licenses', 'notes', 'assets', 'LIBRARY_LICENSES.md', 'WYSIWYG_INPUT_BEHAVIORS.md', 'WYSIWYG_INPUT_BEHAVIORS.ko.md', 'LICENSE', '.nojekyll']) {
