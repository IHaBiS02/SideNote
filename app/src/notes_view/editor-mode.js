...
import { activeNoteId, globalSettings, isPreview, setIsPreview, } from '../state.js';
/** Returns the label used to leave source editing for the configured Preview mode. */
function getPreviewModeButtonLabel() {
...
function applyEditorDisplayMode() {
    markdownEditor.style.display = 'block';
    if (isPreview) {
        markdownEditor.setMode?.(normalizeGlobalSettings(globalSettings).wysiwygPreview ? 'wysiwyg' : 'readonly');
...
export { applyEditorDisplayMode, getPreviewModeButtonLabel, togglePreview, };
