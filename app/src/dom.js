...
const sourceLineHeightSetting = document.getElementById('source-line-height-setting');
const codeLineHeightSetting = document.getElementById('code-line-height-setting');
const pinnedNoteDragDelaySetting = document.getElementById('pinned-note-drag-delay-setting');
const pinnedNoteDragDelayContainer = document.getElementById('pinned-note-drag-delay-container');
...
const showTildeReplacementButtonCheckbox = document.getElementById('show-tilde-replacement-button-checkbox');
...
const wysiwygPreviewCheckbox = document.getElementById('wysiwyg-preview-checkbox');
const preventExtraEmptyParagraphsCheckbox = document.getElementById('prevent-extra-empty-paragraphs-checkbox');
const preventExtraEmptyParagraphsContainer = document.getElementById('prevent-extra-empty-paragraphs-setting');
// === 가져오기/내보내기 요소 ===
...
export { listView, editorView, noteList, newNoteButton, backButton, deleteNoteButton, editorTitle, markdownEditor, toggleViewButton, settingsView, settingsButton, globalSettingsButton, settingsBackButton, licensesButton, licenseView, licenseBackButton, licenseContent, titleSetting, fontSizeSetting, lineHeightSetting, sourceLineHeightSetting, codeLineHeightSetting, pinnedNoteDragDelaySetting, pinnedNoteDragDelayContainer, modeSetting, autoLineBreakButton, tildeReplacementButton, showTildeReplacementButtonCheckbox, legacyLineBreakModeCheckbox, codeBlockHeaderCheckbox, wysiwygPreviewCheckbox, preventExtraEmptyParagraphsCheckbox, preventExtraEmptyParagraphsContainer, globalExportButton, globalImportButton, globalImportInput, exportNoteButton, importNoteButton, importNoteInput, recycleBinButton, recycleBinView, recycleBinBackButton, deletedNoteList, imageManagementButton, imageManagementView, imageManagementBackButton, imageList, deletedItemsList, emptyRecycleBinButton, preventUsedImageDeletionCheckbox };
