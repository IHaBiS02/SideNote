...
-   **`src/`**: This directory contains all the JavaScript logic for the extension, broken down into modules.
    ...
    -   `editor/`:
        -   `sidenote-editor-adapter.js`: Connects the reusable `<wysiwyg-markdown>` component to SideNote image storage, paste processing, and editor modes.
...
-   **`wysiwyg-markdown.js`**: Self-contained Lit/ProseMirror-based Web Component bundle generated by the parent editor project and checked in so SideNote release builds remain standalone.
